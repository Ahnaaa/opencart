...
class __TwigTemplate_89950d68752f43220b90f118ac8e6e20 extends Template
{
    private $source;
    private $macros = [];
...
\$('#path').on('click', 'a.file', function (e) {
    ...
    if (!editor['#tab-' + tab_id]) {
        ...
        // line 199
        echo twig_escape_filter($this->env, ($context["button_reset"] ?? null), "js");
        echo "</button>';
                    html += '  </div>';
                    html += '</div>';
...
";
    ...
    {
        return new Source("", "admin/view/template/design/theme.twig", "/Applications/MAMP/htdocs/opencart/upload/admin/view/template/design/theme.twig");
    }
}
