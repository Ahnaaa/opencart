...
class __TwigTemplate_9fa0a8ee7707240868baa3181015962a extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"card\">
      ...
      <div class=\"card-body\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["order_status"]) {
            ...
            echo "\"";
            if ((twig_get_attribute($this->env, $this->source, $context["order_status"], "order_status_id", [], "any", false, false, false, 26) == ($context["payment_free_checkout_order_status_id"] ?? null))) {
                echo " selected";
            }
            echo ">";
...
";
    ...
    {
        return new Source("", "extension/opencart/admin/view/template/payment/free_checkout.twig", "/Applications/MAMP/htdocs/opencart/upload/extension/opencart/admin/view/template/payment/free_checkout.twig");
    }
}
