...
class __TwigTemplate_8ba07733a813d3e6c6cf6ecb71918f0b extends Template
{
    private $source;
    private $macros = [];
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["language"]) {
            ...
            if ((($__internal_compile_0 = ($context["banner_images"] ?? null)) && is_array($__internal_compile_0) || $__internal_compile_0 instanceof ArrayAccess ? ($__internal_compile_0[twig_get_attribute($this->env, $this->source, $context["language"], "language_id", [], "any", false, false, false, 58)] ?? null) : null)) {
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["banner_image"]) {
                    ...
                    echo twig_get_attribute($this->env, $this->source, $context["banner_image"], "sort_order", [], "any", false, false, false, 81);
                    echo "\" placeholder=\"";
                    echo ($context["entry_sort_order"] ?? null);
                    echo "\" id=\"input-image-";
                    echo twig_get_attribute($this->env, $this->source, $context["language"], "language_id", [], "any", false, false, false, 81);
...
\$('button[id^=\\'button-banner\\']').on('click', function () {
    ...
    html += '        <button type=\"button\" data-oc-toggle=\"image\" data-oc-target=\"#input-image-' + \$(element).attr('data-language') + '-' + image_row + '-image\" data-oc-thumb=\"#thumb-image-' + \$(element).attr('data-language') + '-' + image_row + '\" class=\"btn btn-primary btn-sm btn-block\"><i class=\"fa-solid fa-pencil\"></i> ";
        // line 121
        echo twig_escape_filter($this->env, ($context["button_edit"] ?? null), "js");
        echo "</button>';
    html += '        <button type=\"button\" data-oc-toggle=\"clear\" data-oc-target=\"#input-image-' + \$(element).attr('data-language') + '-' + image_row + '-image\" data-oc-thumb=\"#thumb-image-' + \$(element).attr('data-language') + '-' + image_row + '\" class=\"btn btn-warning btn-sm btn-block\"><i class=\"fa-regular fa-trash-can\"></i> ";
        // line 122
...
";
    ...
    {
        return array (  466 => 135,  455 => 127,  451 => 126,  444 => 122,  440 => 121,  432 => 118,  426 => 115,  420 => 112,  410 => 105,  400 => 98,  397 => 97,  373 => 91,  367 => 87,  364 => 86,  358 => 85,  356 => 84,  349 => 82,  335 => 81,  320 => 77,  308 => 76,  295 => 74,  285 => 73,  267 => 68,  259 => 65,  245 => 64,  239 => 61,  236 => 60,  231 => 59,  229 => 58,  221 => 53,  217 => 52,  213 => 51,  209 => 50,  203 => 47,  194 => 46,  176 => 45,  174 => 44,  170 => 42,  143 => 40,  126 => 39,  115 => 33,  108 => 29,  98 => 24,  93 => 22,  88 => 20,  83 => 18,  76 => 13,  65 => 11,  61 => 10,  56 => 8,  50 => 7,  46 => 6,  37 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("", "admin/view/template/design/banner_form.twig", "/Applications/MAMP/htdocs/opencart/upload/admin/view/template/design/banner_form.twig");
    }
}
